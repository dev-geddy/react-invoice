    ...
    return (
      <Fragment>
        ...
        <Grid container justifyContent="left" spacing={1} sx={{p: 0}}>
          ...
          <Grid item sx={{width: 120, p: 1}}>
            <TextField disabled={locked} label={labels.invoiceNumber} name="invoiceNo" value={meta.invoiceNo} onChange={this.handleChange} fullWidth size="small" margin="dense" {...inputStyle} />
          </Grid>
        </Grid>
        ...
        <Grid container justifyContent="left" spacing={1} sx={{p: 0}}>
          ...
          <Grid item sx={{width: 120, p: 1}}>
            <TextField disabled={locked} label={labels.vatRatePct} name="invoiceDate" value={meta.vatRate} onChange={this.handleChange} fullWidth size="small" margin="dense" {...inputStyle} />
          </Grid>
